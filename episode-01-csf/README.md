# Episode 1 lab: build Meridian's CSF profile

> Pairs with the Field Notes article "The map I wish someone had given me: what NIST is, and the CSF in plain English."

The article explains what the Cybersecurity Framework is. This is where you use it. A profile is the framework's most practical output: an honest picture of where you are now and where you want to be, and the gap between them becomes your to-do list.
...
1. Open the worked example. Read the "How to use" tab, then look down the Gap column. The red cells are Meridian's weak spots. Notice they cluster in Oversight, Detection, and Improvement, which is exactly what you would expect from a young, fast-moving company.
