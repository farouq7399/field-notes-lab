...
- **system-boundary.png**: the authorisation boundary for the Customer Web Portal (S2), used in the RMF walkthrough. What is inside the line is what the sign-off covers.

All three are fictional and for teaching only.
